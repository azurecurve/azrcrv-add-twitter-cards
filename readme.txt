...
== Installation ==
To install the Add Twitter Cards plugin:
* Download the plugin from <a href='https://github.com/azurecurve/add-twitter-cards/'>GitHub</a>.
...
= 1.0.0 =
* First version. Idea and some code from [Code Potent](https://codepotent.com/).
